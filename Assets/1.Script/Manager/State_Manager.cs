...
{
    public enum State_Type{Damage, HP, MP, speed}
        ...
        if( GameManager.Instance.ap != 0)
        {
            switch(state_Type)
            {
                ...
                case State_Type.HP:
                    ...
                    GameManager.Instance.ap_hp = GameManager.Instance.ap_hp_Level * GameManager.Instance.ap_hmp_plus;
                    GameManager.Instance.player_Max_Hp = 100 +  GameManager.Instance.ap_hp;
                    break;
                case State_Type.MP:
                    GameManager.Instance.ap_mp_Level ++;
                    GameManager.Instance.ap_mp = GameManager.Instance.ap_mp_Level * GameManager.Instance.ap_hmp_plus;
                    GameManager.Instance.player_Max_Mp = 100 + GameManager.Instance.ap_mp;
                    break;   
                case State_Type.speed:
                    GameManager.Instance.ap_speed_Level++;
                    GameManager.Instance.ap_speed = GameManager.Instance.ap_speed_Level * GameManager.Instance.ap_speed_plus;
                    break;
            }
